...
sjmisc::find_var(elsoc16,"cod_")
sjmisc::find_var(elsoc17,"cod_")
sjmisc::find_var(elsoc18,"cod_")
sjmisc::find_var(elsoc19,"cod_")
```
...
w01$mov_educ <- as.numeric(w01$educacion_n-w01$edparent_n) 
sjmisc::frq(w01$mov_educ)
...
wide01_fix <- 
  ...
  mutate(mujer.w2=mujer.w1,
         ...
         edad.w3=edad.w1,
         edad.w4=edad.w1,
         mov_educ.w1=mov_educ,
         mov_educ.w2=mov_educ,
         mov_educ.w3=mov_educ,
         mov_educ.w4=mov_educ)
```
...
```{r eval=FALSE, include=FALSE}
#Education
wide01$educ <- car::recode(wide01$ed,
                                         "c(1,2,3)=1;c(4,5)=2;c(6,7)=3;c(8,9,10)=4; c(-888,-999)=NA")
elsoc_long_2016_2019$educ <- factor(elsoc_long_2016_2019$educ,
                                    labels = c("Basica","Media","Tecnica","Universitaria"))

#Recoding of education to years based on casen 2017.
elsoc_long_2016_2019$educ_n<- car::recode(elsoc_long_2016_2019$m01,
                                          "1=0;2=4.3;3=7.5;4=9.8;5=12.02;6=13.9;7=14.8;8=14.9;9=16.9;10=19.07;c(-888,-999)=NA", as.numeric = T)
...
elsoc_long_2016_2019$quintil1 <- 
  car::recode(elsoc_long_2016_2019$quintil, 
...
long01<- melt(wide01, id.vars = "idencuesta",
              ...
              measure = patterns("^mujer.","^edad.","^educacion.","^ess.","^essfam.",
                                 "^movsubj.","^mov_sub_c.","^mov_educ.",
                                 "^income_pc.","^inc05.","^mov_income.","^mov_inc05",
                                 "^mov_median_inc.","^mov_ess.",
